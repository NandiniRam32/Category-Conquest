...
export const QuestionArcade = ({setCurrentPage, setPoints, level, category, currentTeam, points, setStatus, setCurTeam, backgroundColor, 
    ...
    setCurrQ(newQuestions[randomIndex].text);
    setAnswers(newQuestions[randomIndex].options);
    setCorrect(newQuestions[randomIndex].correctAnswer);
    
    const timerInterval = setInterval(() => {
      setTimeLeft((prevTime) => {
        if (prevTime === 1) {
          handleAnswerClick('hello');
