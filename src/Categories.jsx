        ...
        <div className="teamsContainer">
            <div style={{ background: "black", width: "100vw", height: "100vh", color: "white", alignContent: "center"}}>
                ...
                <div style={{marginLeft: "8vw"}}>
                    ...
                    <text style={{background: "#ff6bee", marginRight: "6vw"}} className={`teamsChoice1 ${handleCategoryDisappear("popCulture") 
                ...
                <div style={{marginLeft: "8vw", marginTop: "10vh"}}>
                    ...
                    <text style={{background: "#c66bff", marginRight: "6vw"}} className={`teamsChoice1 ${handleCategoryDisappear("sports") 
                    ? 'hidden' : ''}`} onClick={() => handleSetCategory("sports")}><b>Sports</b></text>
                </div>
                <div style={{marginLeft: "8vw", marginTop: "10vh"}}>
                    <text style={{background: "#ff6bee", marginRight: "6vw"}} className={`teamsChoice1 ${handleCategoryDisappear("geography") 
                    ? 'hidden' : ''}`} onClick={() => handleSetCategory("geography")}><b>Geography</b></text>
                    <text style={{background: "#28fc81", marginRight: "6vw"}} className={`teamsChoice1 ${handleCategoryDisappear("cuisine") 
                ...
                <div style={{marginLeft: "8vw", marginTop: "10vh"}}>
                    ...
                    <text style={{background: "#44d8fc", marginRight: "6vw"}} className={`teamsChoice1 ${handleCategoryDisappear("general") 
